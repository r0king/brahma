      ...
      <div className="flex flex-col md:flex-row-reverse relative justify-between px-3">
        <div className="flex flex-col md:order-2 md:ml-auto">
          {/* <Parallax translateY={isMobile ? [0, 0] : [60, -21]} easing="ease" className="flex flex-col ml-auto"> */}
            <h1 className="uppercase order-2 text-center md:text-left font-morganite text-[30vw] md:text-[22vw] leading-[0.75] md:ml-3 mt-5">
              About Us
            </h1>
        ...
        {/* <Parallax translateY={isMobile ? [0, 0] : [10, -10]} easing="ease"> */}
          <div className="order-1 mx-3 md:mr-10 mt-10 md:mt-0 mb-[4vw] shadow-overlay-reverse relative rounded-md rounded-tr-[7vw] md:max-w-[50vw]">
            <video
              width={"800"}
              className="aspect-video hover:opacity-80 object-cover brightness-60 rounded-md rounded-tr-[7vw] md:max-w-[50vw]"
              src={brahmaVideo}
              autoPlay
              loop
              muted
