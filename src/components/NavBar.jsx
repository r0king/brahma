  ...
  return (
    ...
    <nav className="text-black w-full font-poppins font-bold sticky -top-1 bg-accent z-30">
      <div className="flex justify-end items-center w-full">
        <label
          id="logo"
          className={`font-semibold pl-[4vw] relative z-[55] ${fade
        ...
        <div className="flex justify-end items-center w-full text-[12px] text-primary">
          <div className="hidden md:flex w-full justify-end ">
            <a className=" cursor-pointer p-2 hover:opacity-100 pt-1 font-bold opacity-[0.6]" name="speakers" onClick={handleClick} >
              Speakers
            </a>
      ...
      <div>
        <div
          ...
          gap-2 p-2 pb-6 z-50 md:hidden fixed w-screen h-screen top-0 left-0 flex justify-end flex-col font-normal 
