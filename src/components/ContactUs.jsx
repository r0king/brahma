  ...
  return (
    <div id="contact" ref={myRef} className="flex p-3 pb-5 md:p-6 bg-[#212121] justify-center items-center relative z-10">
      <div
        className="
         w-[90vw]    
         border-[1px] border-[#fafafa75]  rounded-tr-3xl  
         bg-clip-padding   
         overflow-hidden"
        style={{
          boxShadow: " ",
      ...
      >
        ...
        bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border border-gray-100'></div> */}
          ...
          >
            <img src={ ""} alt="Asiet Logo" className=" pl-0 md:pl-0    md:pt-0 pb-5" srcSet="" />
            {/* ::Title Contact */}
            ...
            <div className="mt-5 sm:mt-5 space-y-3">
              <h3 className="text-lg text-[#f0f0f0] font-medium">Address</h3>
            ...
            <div className="mt-5 sm:mt-5 flex items-center ">
              <h3 className="text-base text-[#f0f0f0]   font-medium uppercase tracking-wider">
                Social
              </h3>
              <div className="ml-3 flex space-x-2">
                ...
                <a
                  href="#facebook"
                  aria-label="facebook"
                  className="p-1 inline-flex justify-center items-center text-sec-color hover:text-blue-400"
                >
                  <svg
                ...
                <a
                  href="#twitter"
                  aria-label="twitter"
                  className="m-2 p-1 inline-flex justify-center items-center text-sec-color hover:text-blue-400"
                >
                  <svg
          ...
          {/* :MAP CONTAINER */}
          <div className="col-span-full sm:col-span-3 border-t-[1px] border-[#fafafa3d]  rounded-tr-3xl">
            {/* Embed Google map */}
            <iframe
